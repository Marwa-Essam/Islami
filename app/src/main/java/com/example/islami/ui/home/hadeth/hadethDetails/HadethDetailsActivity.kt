package com.example.islami.ui.home.hadeth.hadethDetails
...
import com.example.islami.ui.home.quran.suraDetails.VersesAdapter
...
class HadethDetailsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        initRecyclerView()
        val hadethName = intent.getStringExtra(Constants.EXTRS_HADETHNAME)//key not value
